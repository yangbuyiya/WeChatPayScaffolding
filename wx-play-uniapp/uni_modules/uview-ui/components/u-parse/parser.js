...
const config = {
    ...
    // 要移除的标签
    ignoreTags: makeMap('area,base,canvas,embed,frame,head,iframe,input,link,map,meta,param,rp,script,source,static,textarea,title,track,wbr'),
    // 自闭合的标签
    ...
    // #ifndef APP-PLUS-NVUE
        address: 'font-static:italic',
        big: 'display:inline;font-size:1.2em',
        caption: 'display:table-caption;text-align:center',
        center: 'text-align:center',
        cite: 'font-static:italic',
        dd: 'margin-left:40px',
...
parser.prototype.popNode = function () {
  ...
  || node.name == 'iframe' // #endif
        ...
        let str = '<video static="width:100%;height:100%"' // 空白图占位
