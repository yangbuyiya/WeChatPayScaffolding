 ...
 * @author yangshuai
 */
public class WechatPay2ValidatorForRequestConfig {

    protected static final Logger log = LoggerFactory.getLogger(WechatPay2ValidatorForRequestConfig.class);
    /**
     * 应答超时时间，单位为分钟
     */
     ...
     *
     * @param verifier  验证类
     * @param requestId 通知唯一ID
     */
    public WechatPay2ValidatorForRequestConfig(Verifier verifier, String requestId, String body) {
